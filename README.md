...
|-----------|-------------|------|
| [fmri-pooling](docs/experiments/fmri-pooling/) | Pooling Small-N fMRI: Can many small open fMRI studies be merged into one shared space? Same pipeline, two films, opposite answers: alignment hurt on a non-narrative tone-poem (N=93) and helped on a narrative film (N=19 × 8 runs) — a measured map of where pooling works | [View](https://nimblecoorg.github.io/open-science/experiments/fmri-pooling/) |
